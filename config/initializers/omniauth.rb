...
Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  provider :google_apps, "uptospeed.se", "g_ysByjed_wnqipVx2bk8Quf", :scope => "https://www.google.com/calendar/feeds/", :domain => "newsdesk.se", :identifier => "https://www.google.com/accounts/o8/id", :callback_path => "/auth/google_apps/callback"
end