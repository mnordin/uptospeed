...
Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  provider :google_apps, nil, :scope => "http://www.google.com/calendar/feeds/, http://www.google.com/base/feeds/, http://www.google.com/m8/feeds", :domain => "newsdesk.se", :identifier => "https://www.google.com/accounts/o8/id", :callback_path => "/auth/google_apps/callback"
end